...
int Start_Menu(number n)
{
	...
	while (n != 0)
	{
			...
			cout << "   список RGZ ------> 1\n   список Наслідник наукові робот ---- > 2\n   список Наслідник збирники завдань ---- > 3\n  ";
...
int RGZ::main_menu(number e)
{
	...
	std::cout << "  7. Відобразити елемент списку які мають два слова у назві \n";
	std::cout << "  8. Записати данi y файл \n";
	std::cout << "  9. Вивести данi файлу на екран \n"; 
	std::cout << "  10. ?Сортувати \n";
	

	std::cout << "  11. Перейти до додаткового меню \n";
	std::cout << "  12. Перейти до попереднього меню \n";
	std::cout << "  13. ?(НЕ НАТИСКАТИ)Перезавантажити програму програму \n";
	std::cout << "  14. Завершити роботу \n";
