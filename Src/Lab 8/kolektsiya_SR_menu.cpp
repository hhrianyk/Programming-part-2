...
int kolektsiya_SR::main_menu(number e)
{
	...
	std::cout << "  6. Сортувати... \n";
    std::cout << "  7. Пошук зiбірника ргз за автором \n";
	std::cout << "  8. Перейти до додаткового меню \n";
	std::cout << "  9. Перейти до попереднього меню \n";
	std::cout << "  10. Перезавантажити клас \n";
...
int kolektsiya_SR::vstup_info(number nov, List_SR& List)
{
	...
	while (a)
	{
		...
		case 5:
			...
			std::cout << "Успішно";
			break;
		case 6:h.sortSTR(List);
			return 0;
		case 7:system("cls"), h.poshuk(List);
		break;
...
int kolektsiya_SR::kriter(number n)
{
	...
	SetConsoleTextAttribute(hConsole, (WORD)(11));
	cout << "  1.Предмет\n";
	cout << "  2.Збірник завдань\n";
	cout << "  3.Автор  \n";
	cout << "  4.Видавництво\n";
	cout << "  5.Рік видавництва\n";
	SetConsoleTextAttribute(hConsole, (WORD)(10));
	cout << " \nваш вибiр: ";
	cin >> n;
	return n;
